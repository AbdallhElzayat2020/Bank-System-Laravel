            ...
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 ">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ round($invoices_total, 2) }}
                                </h4>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ round($invoices_unPaid_total, 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير{{ $invoices_unPaid_count }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    -{{ round(($invoices_unPaid_count / $invoices_count) * 100, 2) }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ round($invoices_Paid_total, 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير{{ $invoices_Paid_count }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span
                                    class="text-white op-7">{{ round(($invoices_Paid_count / $invoices_count) * 100, 2) }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 ">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ round($invoices_partial_total, 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير{{ $invoices_partial_count }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ round(($invoices_partial_count / $invoices_count) * 100, 2) }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
